<template>
  <div v-if="!error">
    ...
    <div class="col-12 pt-2 pb-1 text-center border-bottom">
      <h5 class="font-weight-bolder customer-title" v-if="orderHeader.length>0">
      ...
      <div v-if="orderHeader.length>0" class="col-12 p-0 text-center text-muted">
        <p class="m-0">
          <small>Puede Revisar la información de su pedido en el siguiente enlace</small>
        </p>
    ...
    <div class="col-12 m-auto p-0 d-flex flex-col flex-sm-row row">
      <section class="container-md p-0 p-sm-3 col-12 col-sm-6 order-2 order-sm-1">
        <div class="col-12 p-0" v-for="(product, index) in orderProducts" :key="index">
            ...
            <div class="row no-gutters h-100">
              ...
              <div class="col-8">
                <div class="card-header bg-transparent relative p-1">
                  <h5 v-text="product.nombre" class="overflow-hidden text-nowrap m-0"></h5>
                </div>
                <div class="card-body p-1">
                  ...
                  <p class="card-text p-0">
                    <small class="text-muted">{{product.quantity}}x{{currency+' '+product.price}}</small>
                  </p>
                </div>
      ...
      >
        <div class="col-12 p-0 bg-white h-100">
          <table class="table table-sm table-bordered m-0" v-if="orderCustomer.length>0">
            ...
            <tr>
              ...
              <td class="text-center">
                <label class="text-muted m-0" for v-if="orderHeader.length>0">
                  <span class="badge badge-info" v-text="orderHeader[0].estado"></span>
                </label>
              </td>
            </tr>
            <tr>
              ...
              <td class="text-left">
                <label class="text-muted m-0" for v-text="orderCustomer[0].nombre"></label>
              </td>
            </tr>
            <tr>
              <th class="totalize text-black" style="width:1%">Ciudad</th>
              <td class="text-left">
                <label class="text-muted m-0" for v-text="orderCustomer[0].ciudad"></label>
              </td>
            </tr>
            <tr>
              <th class="totalize text-black" style="width:1%">Direccion</th>
              <td class="text-left">
                <label class="text-muted m-0" for v-text="orderCustomer[0].direccion"></label>
              </td>
            </tr>
            <tr>
              <th class="totalize text-black" style="width:1%">Email</th>
              <td class="text-left">
                <label class="text-muted m-0" for v-text="orderCustomer[0].email"></label>
              </td>
            </tr>
            <tr>
              <th class="totalize text-black" style="width:1%">Comentarios</th>
              <td class="text-left">
                <label class="text-muted m-0" for v-text="orderCustomer[0].comentario"></label>
              </td>
            </tr>
            <tr>
